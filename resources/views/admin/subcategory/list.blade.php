      ...
      <div class="card">
        ...
        <div class="card-header">
          ...
          <div class="card-title">
            ...
            <button type="button" onclick="window.location.href='{{ route('sub_categories.index') }}'" class="btb btn-default btn-sm">Reset</button>
            {{-- <a href="{{ route('categories.index') }}" class="btb btn-default btn-sm">Reset</a> --}}
